...
### Added
- **Cline v3.38.2 Complete Integration**: Fully integrated all features from Cline v3.38.2, including the latest model support and core improvements (including Claude Opus 4.5).
...
- **Enhanced Provider Setup**: Auto-fetching models for LiteLLM and BizRouter with real-time health checks.
