 ...
 *
 * @see work-logs/luke/caret/todo/doing/2026-01-14-glm47-loop-issue.md
 */
 ...
 * Used in Caret mode for proper loop termination
 *
 * @param finishReason - The finish reason from the API
 * @param didToolUse - Whether the assistant used any tools in this turn
 * @param consecutiveMistakeCount - Number of consecutive non-tool responses (unused in Caret mode)
...
export function shouldEndLoopByFinishReason(
	...
	// Note: This is only called in Caret mode (checked in task/index.ts)
