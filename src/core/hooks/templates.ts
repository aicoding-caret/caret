...
#
# Input: { taskId, taskStart: { task: string }, caretVersion, timestamp, ... }
...
#
# Input: { taskId, taskResume: { task: string }, caretVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
#
# Use cases:
...
#
# Input: { taskId, taskCancel: { task: string }, caretVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
#
# Use cases:
...
#
# Input: { taskId, taskComplete: { task: string }, caretVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
#
# Use cases:
