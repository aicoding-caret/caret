...
<Note>
캐럿(Caret) 기준 문서입니다. Cline v3.38.1 머지본을 따르며, 캐럿 전용 정책(지원 모델/권장 설정, 인증/라우팅)이 있을 경우 본문에서 `<Note>`로 표시합니다.
</Note>
...
- **Have questions?** Join our [Discord community](https://https://discord.gg/WB6yaR89YN)
