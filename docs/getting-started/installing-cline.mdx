...
<Note>
이 가이드는 Cline v3.38.1 머지본을 기준으로 캐럿(Caret)에 맞춰 작성되었습니다. 캐럿 전용 정책(지원 OS/스토어, 인증·라우팅, 모델 제한)이 있는 경우 각 섹션에 `<Note>`로 표시합니다.
</Note>
...
<Tabs>
  <Tab title="VS Code/Cursor" icon="code">
    ...
    **Common Issues**
    ...
    Need help? Join our [Discord community](https://https://discord.gg/WB6yaR89YN).
...
<CardGroup cols={2}>
  <Card title="Join Our Discord" icon="discord" href="https://https://discord.gg/WB6yaR89YN">
