...
## 📋 Overview
Caret standardizes agent rules to the AAIF model and adopts a **Dual-directory Architecture**:
...
- **Master Plan**: `work-logs/luke/caret/todo/todo/context-improvement/master-implementation-plan.md`
