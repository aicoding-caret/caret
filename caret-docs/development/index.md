# 개발 문서 대시보드 (Development Documentation Dashboard)

Caret 개발자가 확인해야 할 KO 우선 문서 모음입니다. `features` 만 EN 병행을 유지하며, `.caretrules` 워크플로우와의 매핑을 함께 표기합니다.
...
- **[Cline 수정 안전 가이드](./cline-modification.md)** ↔ `.caretrules/workflows/cline-modification.md`
- **[테스팅 가이드](./testing-guide.md)** ↔ `.caretrules/workflows/testing-work.md` (+ `atoms/tdd-cycle.yaml`)
- **[AI 작업 프로토콜](./ai-work-protocol.md)** / **인덱스** ↔ `.caretrules/workflows/ai-work-protocol.md`
- **[브랜딩/B2B 워크플로우](./b2b-branding-workflow.md)** ↔ `.caretrules/workflows/branding-and-logging.md`
- **[새 컴포넌트 만들기](./new-component.md)** ↔ `.caretrules/workflows/new-component.md`
- **[문서 정리 가이드](./document-organization.md)** ↔ `.caretrules/workflows/document-organization.md`
- **[크리티컬 검증](./critical-verification.md)** ↔ `.caretrules/workflows/critical-verification.md`
- **[AI 기능 워크플로우](./ai-feature.md)** ↔ `.caretrules/workflows/ai-feature.md`
- **[테스팅 작업](./testing-work.md)** ↔ `.caretrules/workflows/testing-work.md` (중복 내용, 통합 검토 예정)
...
- **[메시지 처리/체크포인트 아키텍처](./message-processing-architecture.md)** / **[checkpoint-architecture](./checkpoint-architecture.md)**
...
## 📚 레퍼런스/규약
- **[모델 지원 목록 (KO)](./support-model-list.md)** / **[Model List (EN)](./support-model-list.en.md)**
- **[로케일 규칙](./locale.md)**
