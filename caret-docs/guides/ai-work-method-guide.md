...
- `caret-docs/development/frontend-backend-interaction-patterns.md` ⚡ **MANDATORY**
- `caret-docs/development/caret-architecture-and-implementation-guide.md` (섹션 10-11)
- `caret-docs/development/message-processing-architecture.md`
...
- `caret-docs/development/component-architecture-principles.md` ⚡ **MANDATORY**
- VSCode 테마 통합 가이드
- i18n 국제화 패턴
...
- `caret-docs/development/testing-guide.md` ⚡ **MANDATORY**
...
- `caret-docs/development/frontend-backend-interaction-patterns.md` (setPersona 패턴)
...
- [ ] `frontend-backend-interaction-patterns.md` 체크
- [ ] 순환 메시지 방지 패턴 확인
- [ ] 단일 필드 업데이트 패턴 적용
- [ ] gRPC 통신 패턴 준수
