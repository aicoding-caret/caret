<div align="center">
  ...
  <p><strong>Cline v3.38.2 기반 + 듀얼 모드 + 페르소나 시스템 + 완벽한 현지화</strong></p>
...
## 🎉 공식 Caret AI Provider 출시 — 무료 크레딧을 받으세요!

**기쁜 소식입니다!** 이제 공식 Caret AI Provider가 안정화되어 모두가 사용할 수 있습니다:

- 🎉 **무료 크레딧**: 신규 사용자는 **매월 $0.1 (10 크레딧)**을 드립니다! (첫 달 최대 $0.2)
- 🤖 **최신 모델**: Gemini 3, 2.5 Pro, Lite와 같은 강력한 모델을 사용해 보세요.
- 🚀 **간편한 설정**: 설정에서 AI Provider로 "Caret"을 선택하기만 하면 바로 시작할 수 있습니다.
...
👉 **모든 독점 기능 보기**: [기능 인덱스](https://github.com/aicoding-caret/caret/blob/main/caret-docs/features.ko/index.md)
